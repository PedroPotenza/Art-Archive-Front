  ...
  return (
    <div className=" flex justify-center items-center w-full h-[100vh] p-16">
      <div className="flex flex-col w-[400px] h-fit border-4 border-almost-black rounded-2xl shadow-2xl">
        <div className="flex bg-almost-black w-full h-16 p-4 justify-center items-center">
          <p className="text-almost-white text-2xl font-semibold">Welcome Back!</p>
        </div>

        <div className="flex flex-col w-full p-4 ">
          <div className="flex flex-col w-full gap-1 mb-4">
            <label className="text-almost-black text-xl font-semibold">Email</label>
            <input
              className="w-full h-fit border-2  border-almost-black focus-visible:border-golden-yellow-darker focus-visible:shadow-md rounded-md bg-almost-white text-lg px-2 py-1"
              type="email"
          ...
          <div className="flex flex-col w-full gap-1">
            <label className="text-almost-black text-xl font-semibold">Password</label>
            <input
              className="w-full h-fit border-2  border-almost-black focus-visible:border-golden-yellow-darker focus-visible:shadow-md rounded-md bg-almost-white text-lg px-2 py-1"
              type="password"
          ...
          <div className="flex flex-row w-full justify-between items-start">
            ...
            <button
              ...
              className="group relative overflow-hidden border-white w-fit px-4 text-lg mt-4 focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0"
            >
              <div
          ...
          <div className="flex w-full justify-center items-center my-2">
            <p className="text-almost-black text-lg font-semibold">Or</p>
          </div>

          {/* <img src="../../assets/google-icon.png" alt="google-icon" className="w-8 h-8" /> */}
          <button
            className="group relative overflow-hidden border-white text-lg w-full focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-"
